...
namespace Particle_Life_Explorer.Gfx
{
	...
	{
		public VertexArray(GlProgram program, float[] positions, float[] colors)
		{
			if (program == null)
	...
	{
		public static GlProgram Default()
        {
			return new GlProgram(GlShaders.VertexSource, GlShaders.FragmentSource);
        }
